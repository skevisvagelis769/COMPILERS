...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOK_VARIABLE = 4,               /* TOK_VARIABLE  */
  YYSYMBOL_TOK_STRING = 5,                 /* TOK_STRING  */
  YYSYMBOL_TOK_MAIN = 6,                   /* TOK_MAIN  */
  YYSYMBOL_TOK_SHOW = 7,                   /* TOK_SHOW  */
  YYSYMBOL_TOK_ASSIGN = 8,                 /* TOK_ASSIGN  */
  YYSYMBOL_TOK_PLUS = 9,                   /* TOK_PLUS  */
  YYSYMBOL_TOK_MINUS = 10,                 /* TOK_MINUS  */
  YYSYMBOL_TOK_MUL = 11,                   /* TOK_MUL  */
  YYSYMBOL_TOK_DIV = 12,                   /* TOK_DIV  */
  YYSYMBOL_TOK_LPAREN = 13,                /* TOK_LPAREN  */
  YYSYMBOL_TOK_RPAREN = 14,                /* TOK_RPAREN  */
...
static const char *const yytname[] =
{
  ...
  "TOK_VARIABLE", "TOK_STRING", "TOK_MAIN", "TOK_SHOW", "TOK_ASSIGN",
  "TOK_PLUS", "TOK_MINUS", "TOK_MUL", "TOK_DIV", "TOK_LPAREN",
  "TOK_RPAREN", "TOK_LBRACE", "TOK_RBRACE", "$accept", "program",
...
{
      30,    -8,    11,    23,   -14,     0,   -14,   -14,    25,    19,
      21,     0,     5,    12,   -14,   -14,   -14,   -14,     5,    28,
      26,    10,    18,     5,     5,     5,     5,   -14,   -14,   -14,
      -9,    -9,   -14,   -14
};
...
{
       0,     0,     0,     0,     3,     0,     1,     9,     0,     0,
       0,     0,     0,     0,     2,     4,    16,    15,     0,     6,
       0,     0,     0,     0,     0,     0,     0,     8,     7,    14,
      10,    11,    12,    13
};
...
{
      21,     7,    25,    26,     8,    22,     4,     9,    16,    17,
      30,    31,    32,    33,    -5,    16,    17,    20,    18,    23,
      24,    25,    26,     6,     5,    18,    28,    23,    24,    25,
      26,     1,    29,    12,    13,    14,     2,    23,    24,    25,
      26,     0,    27,    15
};

static const yytype_int8 yycheck[] =
{
      13,     1,    11,    12,     4,    18,    14,     7,     3,     4,
      23,    24,    25,    26,    14,     3,     4,     5,    13,     9,
      10,    11,    12,     0,    13,    13,    16,     9,    10,    11,
      12,     1,    14,     8,    15,    14,     6,     9,    10,    11,
      12,    -1,    16,    11
};
...
{
       0,     1,     6,    18,    14,    13,     0,     1,     4,     7,
      19,    20,     8,    15,    14,    19,     3,     4,    13,    21,
       5,    21,    21,     9,    10,    11,    12,    16,    16,    14,
      21,    21,    21,    21
};
